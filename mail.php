...
$site_top = "https://10th.bangdream-lv.com";
...
$Referer_check_domain = "https://10th.bangdream-lv.com";
...
$BccMail = "info@bangdream-lv.com";

// 管理者宛に送信されるメールのタイトル（件名）
$subject = "BanG Dream! 10th☆LIVE ライブ・ビューイング WEBからのお問い合わせ";
...
$refrom_name = "BanG Dream! 10th☆LIVE ライブ・ビューイング WEB運営事務局 ";
...
──────────────────────
BanG Dream! 10th☆LIVE ライブ・ビューイング 運営事務局
https://10th.bangdream-lv.com
...
function copyright(){
	echo '<p style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none">- BanG Dream! 10th☆LIVE ライブ・ビューイング WEB運営事務局 -</p>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
